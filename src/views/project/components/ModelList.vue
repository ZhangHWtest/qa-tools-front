  ...
  <div>
          ...
          <template slot-scope="scope">
            ...
            >
              <el-button
                ...
                ricon="el-icon-edit"
                circle
                @click="openEditModelDialog(scope.row.model_id,scope.row.model_name)"
              />
            </el-tooltip>
            <!-- 删除按钮 -->
            <el-tooltip
            ...
            >
              <el-button
                ...
                ricon="el-icon-edit"
                circle
                @click="removeModelById(scope.row.model_id)"
              />
            </el-tooltip>
          </template>
        </el-table-column>
    ...
    >
      ...
      >
        ...
        >
          <el-input
            v-model="editModelBody.model_name"
            placeholder="请输入模块名"
          />
        </el-form-item>
      </el-form>
