  ...
  methods: {
    async getTaskResultInfoMethod () {
      ...
      if (responseBody.code === 1) {
        ...
        this.resultInfo.test_log_url = 'http://192.168.100.38:5000/upload/' + responseBody.data.test_log
        this.resultInfo.test_report_url = 'http://192.168.100.38:5000/upload/' + responseBody.data.test_report
      } else {
